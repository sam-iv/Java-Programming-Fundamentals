...
public class GuestJTest {
	...
	public void testLow() {
		...
		assertEquals(0, guest.calculateTotalChargeWithoutVAT(), 0);
		assertEquals(0, guest.calculateVATChargeAtRate(VATRate.LOW), 0);
	}
	...
	public void testStandard() {
		...
		assertEquals(0, guest.calculateTotalChargeWithoutVAT(), 0);
		assertEquals(0, guest.calculateVATChargeAtRate(VATRate.STANDARD), 0);
	}
}